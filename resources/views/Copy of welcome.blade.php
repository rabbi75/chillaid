...
<div class="bgded overlay" style="background-image:url('assets/frontend/images/backgrounds/01.png');">
...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <section class="group shout">
            <figure class="one_half first"><img src="{{asset('assets/frontend/images/546x356.png')}}" alt="">
                <figcaption class="heading"><a href="#">Accumsan placerat</a></figcaption>
            </figure>
            <figure class="one_half"><img src="{{asset('assets/frontend/images/546x356.png')}}" alt="">
    ...
    <div class="hoc container clear">
        ...
        <ul class="nospace group team">
            <li class="one_third first">
                <figure><a class="imgover" href="#"><img src="{{asset('assets/frontend/images/348x400.png')}}" alt=""></a>
...
<div class="wrapper coloured">
    <section id="testimonials" class="hoc container clear">
        ...
        <article class="one_half first">
            <figure class="clear"><img src="{{asset('assets/frontend/images/100x100.png')}}" alt="">
                <figcaption>
...
<div class="wrapper row3">
    <section class="hoc container clear">
        ...
        <ul id="latest" class="nospace group">
            <li class="one_third first">
                <article><a class="imgover" href="#"><img src="{{asset('assets/frontend/images/348x261.png')}}" alt=""></a>
    ...
    <footer id="footer" class="hoc clear">
        ...
        <div class="one_quarter">
            ...
            <ul class="nospace clear latestimg">
                <li><a class="imgover" href="#"><img src="{{asset('assets/frontend/images/100x100.png')}}" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="{{asset('assets/frontend/images/100x100.png')}}" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="{{asset('assets/frontend/images/100x100.png')}}" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="{{asset('assets/frontend/images/100x100.png')}}" alt=""></a></li>
                <li><a class="imgover" href="#"><img src="{{asset('assets/frontend/images/100x100.png')}}" alt=""></a></li>
...
<script src="{{asset('assets/frontend/js/jquery.backtotop.js')}}"></script>
<script src="{{asset('assets/frontend/js/jquery.mobilemenu.js')}}"></script>
<!-- Homepage specific -->
